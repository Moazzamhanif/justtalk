...
import Avatar from '../../../../src/assets/images/123.jpg';
import {
  StyleSheet,
  Text,
  View,
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <TouchableOpacity
            ...
            <Image source={require('../../../../src/assets/icons/send.png')} />
          </TouchableOpacity>
          <Image source={require('../../../../src/assets/icons/send.png')} style={{marginLeft: '5%'}} />
